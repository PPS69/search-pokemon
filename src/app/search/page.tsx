    ...
    return (
        <>
            <div className='md:px-10 min-h-screen bg-slate-600'>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-3 lg:px-8 gap-6'>
                    ...
                    <div className='p-2 lg:p-8 rounded shadow-lg bg-slate-400 text-center'>
                        ...
                        <div className='grid grid-cols-2 gap-2'>
                            {pokemon.resistant?.map((resistant, index) => {
                                return (
                                    <TypeColor key={index} type={resistant} />
                                );
                            })}
                        </div>
                        ...
                        <div className='grid grid-cols-2 gap-2'>
                            {pokemon.weaknesses?.map((weakness, index) => {
                                return (
                                    <TypeColor key={index} type={weakness} />
                                );
                            })}
                        </div>
                    ...
                    <div className='mt-4 mb-6 col-auto md:col-span-3 rounded shadow-lg bg-slate-400'>
                        ...
                        {pokemon.evolutions == null ? (
                            ...
                            <div className='p-2 md:px-12 grid grid-cols-1 lg:grid-cols-3 sm:grid-cols-2 gap-6'>
                                <Card
                                    src={pokemon.image ?? ''}
                                    name={pokemon.name ?? ''}
                                    number={pokemon?.number ?? ''}
